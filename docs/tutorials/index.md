  ...
  <table>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>Learn about the configuration options of the <i>acoupi_batdetect2</i> program.</td>
      </tr>
      <tr>
        <td>
          <a href="Deployment">Deployment</a>
        </td>
        <td>Learn about <i>acoup_batdetect2_</i> deployment</td>
      </tr>
    </tbody>
  </table>
</div>
...
!!! tip "Contribution"
    ...
    We are interested to expand the number of tutorials so users can gain more detailed information about specific elements of _acoupi_batdetects_. If you feel we should do a tutorial about "XYZ", please reach out!
